...
# ── 中美大模型能力差距锚点 ──────────────────────────────────────
# parity 0-100: 中国综合实力 / 美国综合实力
# 综合 = 纯能力×0.5 + 性价比×0.25 + 开源生态×0.15 + 创新度×0.1
# 纯能力: LLM Stats Score 综合基准
# 性价比: 每美元token数 / 每百万token价格
# 开源生态: 开源模型数量/质量/社区活跃度
# 创新度: 原创架构/训练方法/应用创新
#
# DeepSeek 的核心优势在性价比+开源, 纯能力并未超越美国顶尖

CN_US_PARITY = [
    # (日期, 事件, 综合parity, 纯能力, 性价比, 开源, 创新, 说明)
    ("2022-12-01", "GPT-4 vs 百度文心",       15, 15, 20, 10, 10, "中国大模型刚起步"),
    ("2023-03-15", "GPT-4正式 vs 阿里通义",    18, 16, 25, 15, 15, "中国快速跟进"),
    ("2023-07-15", "Claude 2 vs 百度ERNIE3.5", 22, 18, 28, 20, 20, "开源路径开始"),
    ("2023-12-15", "Gemini vs 百度ERNIE4.0",   25, 22, 30, 25, 22, "中国模型开始追赶"),
    ("2024-02-15", "Sora vs 字节豆包",         28, 25, 32, 28, 25, "多模态差距"),
    ("2024-05-15", "GPT-4o vs 智谱GLM-4",     30, 28, 35, 30, 28, "多模态差距缩小"),
    ("2024-07-15", "Claude3.5 vs 阿里Qwen2",  33, 30, 38, 35, 30, "中国开源路径"),
    ("2024-09-15", "o1 vs 智谱GLM-4/Qwen2.5", 35, 32, 40, 38, 32, "推理能力追赶"),
    ("2024-12-15", "DeepSeek V3发布",          55, 40, 80, 65, 55, "性价比碾压+开源爆发"),
    ("2025-02-15", "Grok 3 vs DeepSeek V3",    50, 38, 70, 60, 50, "纯能力差距仍大"),
    ("2025-03-15", "Claude Opus4 vs DeepSeek", 50, 38, 68, 60, 52, "旗舰对决"),
    ("2025-05-15", "Gemini2.5 vs Qwen2.5",    52, 40, 70, 62, 50, "中国开源生态壮大"),
    ("2025-07-15", "Llama4 vs Qwen3/GLM-4.5", 55, 42, 72, 65, 55, "开源生态同步发展"),
    ("2025-09-15", "GPT-5 vs Kimi K2",         50, 38, 68, 60, 52, "纯能力差距拉大"),
    ("2025-11-15", "Claude4.5 vs GLM-5预览",  55, 42, 72, 62, 55, "长文本中国追赶"),
    ("2026-01-15", "Gemini3.0 vs DS V4预告",  60, 45, 78, 65, 60, "中国加速追赶"),
    ("2026-02-15", "Grok 4 vs 智谱GLM-5",     65, 50, 80, 68, 65, "中国多路径并进"),
    ("2026-03-01", "DeepSeek V4上线",          75, 52, 95, 85, 80, "性价比碾压级, 纯能力仍差一档"),
    ("2026-03-15", "Capybara vs DeepSeek V4",  72, 50, 92, 82, 78, "美国反超纯能力"),
    ("2026-04-15", "GPT-5.5 vs GLM-5.1/DS-V4", 74, 52, 90, 80, 78, "中美多模型交替"),
    ("2026-06-01", "GPT-5.6 vs Qwen3.7/GLM-5.1", 74, 52, 88, 80, 78, "纯能力78% vs 性价比88%"),
]
