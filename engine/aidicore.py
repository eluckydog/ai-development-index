...
# ── 中美大模型能力差距锚点 ──────────────────────────────────────
# parity 0-100: 中国综合最强模型 / 美国综合最强模型
# 来源: LLM Stats Score 综合基准 (2026.06)
#   美国TOP3: OpenAI GPT-5.5=2131, Anthropic Opus4.6=2121, Google Gemini3.1=2111
#   中国TOP3: 智谱GLM-5.1=1759, 阿里Qwen3.7=1680, 月之暗面Kimi2.6=1555
#   其他中国: 小米MiMo-V2.5=1355, 深度求索DeepSeek V4=1292
#   欧洲TOP: Mistral Large 3 ~1300

CN_US_PARITY = [
    ("2022-12-01", "GPT-4 vs 百度文心", 15, "中国大模型刚起步"),
    ("2023-03-15", "GPT-4正式 vs 阿里通义千问", 18, "中国快速跟进"),
    ("2023-07-15", "Claude 2 vs 百度ERNIE 3.5", 22, "差距缓慢缩小"),
    ("2023-12-15", "Gemini vs 百度ERNIE 4.0", 25, "中国模型开始追赶"),
    ("2024-02-15", "Sora vs 字节豆包", 28, "多模态差距"),
    ("2024-05-15", "GPT-4o vs 字节豆包/智谱GLM-4", 30, "多模态差距缩小"),
    ("2024-07-15", "Claude 3.5 Sonnet vs 阿里Qwen2", 33, "中国开源路径"),
    ("2024-09-15", "o1 vs 智谱GLM-4/阿里Qwen2.5", 35, "推理能力追赶"),
    ("2024-12-15", "DeepSeek V3 + 阿里Qwen2.5发布", 55, "开源模型重大突破"),
    ("2025-02-15", "Grok 3 vs DeepSeek V3", 50, "美国保持优势"),
    ("2025-03-15", "Claude Opus4 vs 阿里Qwen2.5/DeepSeek", 50, "旗舰对决"),
    ("2025-05-15", "Gemini 2.5 vs 阿里Qwen2.5-72B", 52, "中国开源生态壮大"),
    ("2025-07-15", "Llama4 vs 阿里Qwen3/智谱GLM-4.5", 55, "开源生态同步发展"),
    ("2025-09-15", "GPT-5 vs Kimi K2/DeepSeek V3.5", 50, "差距拉大(百万token)"), 
    ("2025-11-15", "Claude 4.5 vs Kimi K2/GLM-5预览", 55, "长文本中国追赶"),
    ("2026-01-15", "Gemini 3.0 vs DeepSeek V4预告", 60, "中国加速追赶"),
    ("2026-02-15", "Grok 4 vs 智谱GLM-5正式", 65, "中国多路径并进"),
    ("2026-03-01", "DeepSeek V4上线 vs GPT-5", 85, "SWE-Bench超越, 中国最高点"),
    ("2026-03-15", "Capybara泄露 vs DeepSeek V4", 75, "美国反超(Anthropic第四档)"),
    ("2026-04-15", "GPT-5.5+Opus4.7 vs GLM-5.1+DS-V4Pro", 78, "中美多模型交替领先"),
    ("2026-06-01", "GPT-5.6+Gemini3.1 vs Qwen3.7+GLM-5.1", 78, "美国综合仍有微弱优势"),
]
